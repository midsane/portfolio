...
export const Section = ({ id, upperpad = false, dark = false, noTitle = false, title, children }: ({ id: string, upperpad?: boolean, dark?: boolean, noTitle?: boolean, title?: string, children: ReactNode })) => {
    ...
    return <motion.section
        ...
        className={`px-10 ${dark ? "text-white " : "text-white bg-stone-900"} ${upperpad && "pt-20"} border-t sm:px-8 px-4  md:px-10 flex gap-10 justify-center flex-col  items-center border-stone-900 h-screen w-full `} >
