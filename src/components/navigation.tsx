...
export const Navigation = () => {
    return (
        <nav
            className=" flex items-center fixed shadow shadow-accent gap-4 sm:gap-4 top-4 sm:top-5 left-1/2 -translate-x-1/2 right-0 z-50 p-1 sm:p-2
  min-w-[400px]:w-[75%] w-[90%] justify-center sm:w-fit border border-border rounded-full bg-background backdrop-blur-sm"
        >
            <a href="/">
                <img src={favicon} alt="aditya_raj_portfolio" className="w-7 h-7 rounded-full" />
            </a>
